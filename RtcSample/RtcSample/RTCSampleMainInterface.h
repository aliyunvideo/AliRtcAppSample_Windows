...
public:
	...
	void ShowSubscribe(const AliRtc::String uid, int iReflectIndex);                                // 投映订阅流(Reflect subscription stream)
	void ClearChannel(const AliRtc::String uid);                                                    // 清空频道（Clear reflect）
	void ReplaceSubscribeFlow(const AliRtc::String strOldUid, 
	    const AliRtc::String strNewUid, int index);                                                 // 更换订阅流(Close subscription data)
	...
	vector<AliRtc::String> m_vecRemoteInfoList;                                                     // 用户队列
	int m_iThrowingScreenIndex;                                                                     // 投屏位置序列
	...
	AliRtc::String m_strChangeUid;                                                                  // 交换的uid
